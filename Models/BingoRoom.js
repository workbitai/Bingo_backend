...
const PlayerSchema = new mongoose.Schema({
    ...
    completedLines: [[[Number]]], // 3D Array (Cards > Rows > Columns)
...
const BingoRoomSchema = new mongoose.Schema({
    ...
    calledNumbers: { type: [Number], default: [] },
    turnStartTime: { type: Date },      // Kab turn shuru hui
    turnDurationMs: { type: Number, default: 10000 },
...
module.exports = mongoose.model('BingoRoom', BingoRoomSchema);